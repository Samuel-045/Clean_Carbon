    	...
    	public static void partIndv(int fml, double carbonCol) {
        	...
        	if(resp6==1) {
            	...
            	if(tpVeicl==1) {
                	...
                	if(tpCombut==1) {
                    	System.out.println("Quantos litros você abastece por mês no carro? (visto que o consumo médio no Brasil é de 12km por litro)");
                    	ltM=rec.nextInt();
                    	carbonInd =+ ltM * 0.82 * 0.75 * 3.7; //= total de kg CO2 emitido por litro.
                	}else{
                    	System.out.println("Quantos litros você abastece por mês no carro? (visto que o consumo médio no Brasil é de 12km por litro)");
                	...
                	if(tpCombut==1) {
                    	System.out.println("Quantos litros você abastece por mês na moto? (visto que o consumo médio no Brasil é de 12km por litro)");
                    	ltM=rec.nextInt();
                    	carbonInd =+ ltM * 0.82 * 0.75 * 3.7; //= total de kg CO2 emitido por litro.
                	}else{
                    	System.out.println("Quantos litros você abastece por mês na moto? (visto que o consumo médio no Brasil é de 12km por litro)");
